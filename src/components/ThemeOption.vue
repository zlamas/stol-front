...
<template>
  <div :class="['theme-option', id, { selected }]">
    <svg v-if="valid" class="theme-option__icon" fill="none" version="1.1" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="m8.4437 39.556c-4.1258-4.1259-6.4437-9.7216-6.4437-15.556s2.3178-11.43 6.4436-15.556c4.1258-4.1258 9.7216-6.4436 15.556-6.4436s11.431 2.3178 15.556 6.4436l-31.113 31.113z" fill="var(--color-bg)"/>
      <defs>
        <linearGradient :id="`gradient-${id}`" x1="24" x2="24" y1=".49995" y2="47.5" gradientUnits="userSpaceOnUse">
          <stop stop-color="var(--color-main-light)" offset="0"/>
          <stop stop-color="var(--color-main)" offset="1"/>
        </linearGradient>
      </defs>
    </svg>
    <img v-else class="theme-option__icon" src="/images/question.svg?v=2">
  </div>
</template>
